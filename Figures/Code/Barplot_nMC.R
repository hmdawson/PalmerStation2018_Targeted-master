...
dat <- read_csv(dat.filename) %>%
  filter(!str_detect(`SampID`, "EvXSW_A|Ev51Slush_A|Ev15SW_A|EvXCore_A|StaB1_D|StaB1_E|Ev"))
...
#plot
pal <- c(colorRampPalette(brewer.pal(8,"Accent"))(16)[1:16], rep("grey", 1))
...
metab_nMC
save_plot("Figures/Preliminary/Draft_MS3/FigureS7_barplot_nmolCave_noice.pdf", metab_nMC, base_height = 10, base_width = 10)
...
# b.all
# 
# #save_plot("Figures/Preliminary/barplot_nmolCave_all.pdf", b.all, base_height = 10, base_width = 13)
# 
# 
