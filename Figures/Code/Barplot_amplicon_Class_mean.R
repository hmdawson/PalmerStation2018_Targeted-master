...
Class_18S <- ggplot()+
  ...
  theme(legend.title = element_blank(),
        ...
        axis.text.x = element_text(angle=-60, hjust=0, size = 12,color = "black"),
...
save_plot("Figures/Preliminary/Draft_MS3/FigureS2_barplot_18S_mean.pdf", Class_18S, base_height = 10, base_width = 10)
...
save_plot("Figures/Preliminary/Draft_MS3/FigureS3_barplot_16S_mean.pdf", Class_16S, base_height = 10, base_width = 10)
