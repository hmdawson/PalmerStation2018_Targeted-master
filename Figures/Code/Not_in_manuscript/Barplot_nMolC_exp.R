...
b.all.2 <- ggplot()+
  geom_bar(stat = "identity", data = dat.mean.combo, 
           aes(x = Org_Name, y = nmolCave, fill = Identification), color = "black", size = 0.2)+
...
b.all.2
save_plot("Figures/Preliminary/barplot_nmolC_exp.pdf", b.all.2, base_height = 10, base_width = 10)
...
b.all <- ggplot()+
  geom_bar(stat = "identity", position = "fill", data = dat.mean.combo, 
           aes(x = Org_name_plots, y = nmolCave, fill = Identification), color = "black", size = 0.2)+
...
save_plot("Figures/Preliminary/barplot_nmolC_exp_proportional.pdf", b.all, base_height = 10, base_width = 10)
