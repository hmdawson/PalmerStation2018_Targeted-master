...
b.all.2 <- ggplot()+
  geom_bar(stat = "identity", data = dat.mean.combo, 
           aes(x = Sample_type, y = molFractionN_pertotalN, fill = Identification), color = "black", size = 0.2)+
...
b.all.2
save_plot("Figures/Preliminary/barplot_percentPON_all.pdf", b.all.2, base_height = 10, base_width = 14)
