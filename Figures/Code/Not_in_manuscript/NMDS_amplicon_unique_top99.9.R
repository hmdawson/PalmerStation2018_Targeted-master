#this version tries with collapsed ASVs and only top 99.9% abundance
#looks basically the same as using all unique 1222 ASVs not collapsed
...
abu.file <- "RawOutput/18S/18S_taxa_correlation.csv"
