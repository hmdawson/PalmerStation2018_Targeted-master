...
dat <- read_csv(dat.filename) %>%
  filter(!str_detect(`SampID`, "ppt|EvXSW_A|Ev51Slush_A|Ev15SW_A|EvXCore_A"))
...
b.all.2
save_plot("Figures/Preliminary/barplot_nM_field_all.pdf", b.all.2, base_height = 10, base_width = 10)
...
save_plot("Figures/Preliminary/barplot_nM_field_proportional.pdf", b.all, base_height = 10, base_width = 10)
