...
b.all.2
save_plot("Figures/Preliminary/barplot_nM_exp.pdf", b.all.2, base_height = 10, base_width = 10)
...
save_plot("Figures/Preliminary/barplot_nM_exp_proportional.pdf", b.all, base_height = 10, base_width = 10)
