...
#8-11-22
#Tried coloring by individual sample type (including separating out sea ice core sites) and shape by site (which lumps all seawater, sea ice, etc.)
#to do this for real need to add back in the Ev37 core for metabs so colors match
...
d.raw.18S <- ggplot(data = pointlocation.nmds.18S, aes(x =MDS1, y =  MDS2, group = FigureID_separated,
                                                   colour = FigureID_separated,
                                                   fill = FigureID_separated,
                                                   label = FigureID_separated, shape = Site))+
  geom_point(size = 3)+
  geom_polygon(aes(fill = FigureID_separated), alpha = 0.2) +
  annotate("text", x = -0.3, y = -1.25, 
           label = paste0("Stress = ", 
                          round(nmds.18S[['stress']], digits = 5), 
                          "\n p < ", 
  ...
  scale_fill_brewer(palette="Paired", breaks=c('Meltwater', 'SW_2018-11-08', 'SW_2018-11-12', 'SW_2018-11-15', 'SW_2018-11-17', 'SW_2018-11-19', 'Sea-ice core_1','Sea-ice core_2','Sea-ice core_3', 'Meltwater_T', 'Sea ice_T', 'Seawater_T'))+
  scale_colour_brewer(palette="Paired", breaks=c('Meltwater', 'SW_2018-11-08', 'SW_2018-11-12', 'SW_2018-11-15', 'SW_2018-11-17', 'SW_2018-11-19', 'Sea-ice core_1','Sea-ice core_2','Sea-ice core_3', 'Meltwater_T', 'Sea ice_T', 'Seawater_T'))
d.raw.18S   
...
#Plot out the point location for the raw NMDS----
d.raw.16S <- ggplot(data = pointlocation.nmds.16S, aes(x =MDS1, y =  MDS2, group = FigureID_separated,
                                                       colour = FigureID_separated,
                                                       fill = FigureID_separated,
                                                       label = FigureID_separated, shape = Site))+
  geom_point(size = 3)+
  ...
  annotate("text", x = 0.1, y = -1, 
           label = paste0("Stress = ", 
                          round(nmds.16S[['stress']], digits = 5), 
                          "\n p < ", 
                          round(monte.pvalue.result.raw, digits = 3)), size = 3)+
  theme(plot.title = element_text(size = 16),
        axis.title.x = element_text(size = 14),
...
pro.plot <-ggplot(ctest)+
  ...
  geom_point(aes(x=Dimension1, y=Dimension2, colour=FigureID_separated), size= 3) +
  geom_point(aes(x=xDimension1, y=xDimension2, colour=FigureID_separated), size= 3) +
  annotate("text", x = -0.35, y = -0.275, 
           label = paste0("\n p << 0.001"), size = 3)+
  theme(plot.title = element_text(size = 16),
        axis.title.x = element_text(size = 14),
        axis.title.y = element_text(size = 14),
...
#Plot out the point location for the raw NMDS----
d.raw.metab <- ggplot(data = pointlocation.nmds.raw, aes(x =MDS1, y =  MDS2, group = FigureID_separated,
                                                         colour = FigureID_separated,
                                                         fill = FigureID_separated,
                                                         label = FigureID_separated, shape = Site))+
  geom_point(size = 3)+
  ...
  theme(plot.title = element_text(size = 16),
        ...
        legend.title = element_blank(),
        legend.background = element_blank())+
  scale_fill_brewer(palette="Paired", breaks=c('Meltwater', 'SW_2018-11-08', 'SW_2018-11-12', 'SW_2018-11-15', 'SW_2018-11-17', 'SW_2018-11-19', 'Sea-ice core_1','Sea-ice core_2', 'Meltwater_T', 'Sea ice_T', 'Seawater_T'))+
  scale_colour_brewer(palette="Paired", breaks=c('Meltwater', 'SW_2018-11-08', 'SW_2018-11-12', 'SW_2018-11-15', 'SW_2018-11-17', 'SW_2018-11-19', 'Sea-ice core_1','Sea-ice core_2', 'Meltwater_T', 'Sea ice_T', 'Seawater_T'))
...
d.raw <- ggplot(pointlocation.nmds.raw)+
  ...
  theme(axis.title.x = element_text(size = 14),
        ...
        legend.title = element_blank(),
        legend.background = element_blank())+
  scale_fill_brewer(palette="Paired", breaks=c('Meltwater', 'SW_2018-11-08', 'SW_2018-11-12', 'SW_2018-11-15', 'SW_2018-11-17', 'SW_2018-11-19', 'Sea-ice core', 'Meltwater_T', 'Sea ice_T', 'Seawater_T'))+
  scale_colour_brewer(palette="Paired", breaks=c('Meltwater', 'SW_2018-11-08', 'SW_2018-11-12', 'SW_2018-11-15', 'SW_2018-11-17', 'SW_2018-11-19', 'Sea-ice core', 'Meltwater_T', 'Sea ice_T', 'Seawater_T'))+
...
NMDS_withlegend <- plot_grid(NMDS_combo_all, legend_b, ncol = 1, rel_heights = c(1, .1))
NMDS_withlegend

save_plot("Figures/Preliminary/Draft_MS2/Figure_4_NMDS_procrustes_separatedice.pdf", NMDS_withlegend, base_height = 8.5, base_width = 11, units="in")
