...
wide.matrix.2.raw <- data.stand((wide.matrix.2), method='max', margin='row', plot=F)%>% mutate(names = row.names(wide.matrix.2))
...
save_plot("Figures/Preliminary/Tile_field_max_all.pdf", metab_tile_field, base_height = 10, base_width = 15)
