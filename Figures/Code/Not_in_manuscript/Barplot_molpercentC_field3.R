...
b.all <- ggplot()+
  geom_bar(stat = "identity", position = "fill", data = dat.mean.combo, 
           aes(x = Org_Name, y = molFractionC, fill = Identification), color = "black", size = 0.2)+
...
b.all
save_plot("Figures/Preliminary/barplot_molFractionC_field3.pdf", b.all, base_height = 9, base_width = 12)
