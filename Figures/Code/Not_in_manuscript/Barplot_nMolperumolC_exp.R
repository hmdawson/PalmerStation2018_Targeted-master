...
b.all.2
save_plot("Figures/Preliminary/barplot_nMolperumolC_exp.pdf", b.all.2, base_height = 10, base_width = 10)
...
save_plot("Figures/Preliminary/barplot_nMolperumolC_exp_proportional.pdf", b.all, base_height = 10, base_width = 10)
