...
spe.rda2<-rda(metab.dat)
summary(spe.rda2)
ordiplot(spe.rda,type='t', scaling=2)
ordiplot(spe.rda2,choices=c(1,2),scaling=2)
ordiplot(spe.rda2, scaling=1)
...
pdf('RDAMetab18S.pdf', width=10, height=10)
plot(spe.rda, choices=c(1,2), display=c('wa', 'sp', 'bp'), scaling=2)
