...
#plot
pal <- c(colorRampPalette(brewer.pal(8,"Dark2"))(21)[1:21], rep("grey", 1))
...
save_plot("Figures/Preliminary/barplot_molfractionN_exp.pdf", b.all, base_height = 10, base_width = 10)
