...
#ANOVA statistics for diversity
```{r, error = FALSE, warning=FALSE, message=FALSE}
source('SourceCode/ANOVA_diversity.R')
remove(list = ls())
...
#NEED TO ADD ANOVA statistics here for Proline differences across treatments
```{r, error = FALSE, warning=FALSE, message=FALSE}
source('SourceCode/ANOVA_proline.R')
remove(list = ls())
